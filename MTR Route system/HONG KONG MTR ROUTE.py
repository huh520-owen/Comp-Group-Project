...
def route_MTR():
    ...
    route_finder = RouteFinder(map)
    path, total_time = route_finder.dijkstra(start_code, end_code)
    ...
    transfer_analyzer = TransferAnalyzer(station_line)
    transfers = transfer_analyzer.transfer(path)
